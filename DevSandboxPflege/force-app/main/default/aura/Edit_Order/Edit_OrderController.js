// 01.11.2019	BT	removed column "Liefertag"
({
    init : function(component, event, helper) {
        ...
        component.set('v.columns', [
            ...
            // 01.11.2019	BT	removed column "Liefertag"
            //{label: 'Liefertag', fieldName: 'Liefertag__c', type: 'date', editable: false },
    ...
    onSave: function(component, event, helper){
        ...
        helper.saveOrder(component, draftValues);
        component.find("ordersTable").set("v.draftValues", null);
    },*/
