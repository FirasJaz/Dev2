({
    ...
    createOrder: function(component){
        ...
        // case: Console view open the component as Subtab
        if(isConsole){
    ...
    // case: normal view ,open component as new Tab
    else {
    ...
    saveOrder: function(component, draftValues){
        var action = component.get("c.updateOrderSave");
        action.setParams({
            "order": draftValues
        });
        action.setCallback(this, function(response) {
